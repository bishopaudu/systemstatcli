...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -991736911;
...
fn wire__crate__api__simple__get_system_stats_impl(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok(crate::api::simple::get_system_stats())?;
                    Ok(output_ok)
                })())
            }
        },
...
impl SseDecode for crate::api::simple::SystemStats {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_totalMemory = <u64>::sse_decode(deserializer);
        let mut var_usedMemory = <u64>::sse_decode(deserializer);
        let mut var_freeMemory = <u64>::sse_decode(deserializer);
        let mut var_memoryUsagePercent = <f32>::sse_decode(deserializer);
        ...
        let mut var_usedSwap = <u64>::sse_decode(deserializer);
        return crate::api::simple::SystemStats {
            total_memory: var_totalMemory,
            used_memory: var_usedMemory,
            free_memory: var_freeMemory,
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__simple__get_system_stats_impl(port, ptr, rust_vec_len, data_len),
...
impl flutter_rust_bridge::IntoDart for crate::api::simple::SystemStats {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            self.total_memory.into_into_dart().into_dart(),
            self.used_memory.into_into_dart().into_dart(),
            self.free_memory.into_into_dart().into_dart(),
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::simple::SystemStats
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::simple::SystemStats>
    for crate::api::simple::SystemStats
{
    fn into_into_dart(self) -> crate::api::simple::SystemStats {
        self
    }
}
...
impl SseEncode for crate::api::simple::SystemStats {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <u64>::sse_encode(self.total_memory, serializer);
        <u64>::sse_encode(self.used_memory, serializer);
        <u64>::sse_encode(self.free_memory, serializer);
        <f32>::sse_encode(self.memory_usage_percent, serializer);
        ...
        <u64>::sse_encode(self.used_swap, serializer);
    }
}
